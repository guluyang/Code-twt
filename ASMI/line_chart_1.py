...
sub_fig_3.set_ylabel('AUC', fontsize=16, fontproperties='SimHei')
...
sub_fig_5.set_ylabel('AUC', fontsize=16, fontproperties='SimHei')
...
sub_fig_10.set_ylabel('AUC', fontsize=16, fontproperties='SimHei')
sub_fig_10.set_xlabel('每个类别的训练包数量', fontsize=16, fontproperties='SimHei')
sub_fig_10.legend(loc='lower right')
sub_fig_10.grid(alpha=1)

plt.tight_layout()
plt.savefig('main/figures/chart_corel_auc_chinese.pdf', format='pdf')
plt.show()